...
<!--<div id="element" class="toast position-fixed" role="alert" aria-live="assertive" aria-atomic="true" data-autohide="false" style="position: absolute; z-index: 6; margin-left: 6px; margin-top: 10px; max-width: 410px"> 
  <div class="toast-header">
    <strong class="mr-auto"><i class="bi bi-telephone-fill"></i> Contacto</strong>
    <button type="button" class="ml-2 mb-1 close" data-dismiss="toast" aria-label="Close">
      <span aria-hidden="true">&times;</span>
    </button>
  </div>
  <div class="toast-body">
    <b>Telefono 1:</b> 7224304408
    <b>Telefono 2:</b> 7223033139<br>
    <b>Telefono 3:</b> 7228349605
    <b>Correo:</b> mp.servicios20&#64;gmail.com
  </div>
</div>-->
        ...
        @foreach($prod as $pro)
            <div class="col-md-6 p-2 text-center col-sm-6 col-lg-4 col-xl-3">
                <div class="card mb-3 shadow mb-5 bg-white rounded">
                    ...
                    <div class="card-body">
                        <p class="card-text"><b>{{$pro->nombre}}</b></p>
...
<!------------------------ Ayuda y comentarios ------------------------->
    ...
    <div class="col-md-12">
        <button type="button" class="btn btn-lg btn-danger" data-toggle="popover" data-trigger="focus" data-placement="top" data-content="Inicie Sesión Antes">
